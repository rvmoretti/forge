...
| Item-shape guard (warn: >8 globs, >6 criteria, decision-shaped criteria) + stall rule (diagnose-and-narrow before decompose) | v0.15.0 | field (d2dauto T55): mega-item stalled 55min; narrowed retry finished in 24min; a smuggled decision criterion had to be removed mid-flight | CLI warnings at add/update/start + contract build-loop stall rule |
